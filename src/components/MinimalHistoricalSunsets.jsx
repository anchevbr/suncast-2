...
const MinimalHistoricalSunsets = ({
  ...
  return (
    <div className="text-center">
      {/* Year's Best Sunsets */}
      <div>
        <h3 className="text-sm font-medium text-white mb-3">Year's Best Sunsets</h3>
        <div className="relative">
          <div className="absolute top-2 left-2 right-2 h-8 bg-black/50 rounded-lg"></div>
          <div className="relative grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10 gap-2 text-xs">
                    {historicalData.top10 && historicalData.top10.map((sunset, index) => {
                      ...
                      >
                        <div className="flex items-center justify-center space-x-1 py-2 w-full">
                          <div className={`w-3 h-3 rounded-full ${colors.circle}`}></div>
